            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 bg-white rounded-lg shadow-md">
                    <ul class="space-y-6">
                        ...
                        <li class="flex items-center">
                            <i class="bi bi-person-badge-fill text-purple-500 me-2"></i>
                            <span class="font-medium text-gray-700">{{ __('Hora:') }}</span>
                            <span class="ms-2 text-gray-900">{{ $cita->hora}}</span>
                        </li>
                        <li class="flex items-center">
                            <i class="bi bi-person-badge-fill text-purple-500 me-2"></i>
                            <span class="font-medium text-gray-700">{{ __('Duración:') }}</span>
                            <span class="ms-2 text-gray-900">{{ $cita->duracion}}</span>
                        </li>
                    </ul>
                </div>
